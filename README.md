...
git clone https://github.com/cloudfoundry-community/nexus-boshrelease.git
cd nexus-boshrelease
bosh upload release releases/nexus/nexus-1.yml
```
...
Where `- nexus` means you wish to use an existing security group called `nexus`.
